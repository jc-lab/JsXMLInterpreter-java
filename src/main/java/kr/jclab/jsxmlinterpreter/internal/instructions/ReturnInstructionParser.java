...
public class ReturnInstructionParser implements InstructionParser {
    @Override
    ...
    public ParseResult parseInstruction(JsXMLInterpreterParser interpreter, Element codeElement) throws ParseException {
        ...
        return new ParseResult(new ReturnInstruction.Builder()
                .varType(varType)
                .varRef(interpreter.getJexlEngine().createExpression(varRef))
                .varValue(varValue)
                .build());
    }
}
