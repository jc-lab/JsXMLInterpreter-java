...
public class UnacceptableCommandException extends ExecuteRuntimeException {
    ...
    public UnacceptableCommandException(String message, Throwable cause) {
        super(message, cause);
    }

    public UnacceptableCommandException(Throwable cause) {
        super(cause);
    }

    protected UnacceptableCommandException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
